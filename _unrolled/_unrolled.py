...
permuts_10 = (
((0, 1, 30), (-1, 1, 15), (1, 1, 15)),
((0, 1, 30), (1, 1, 15), (-1, 1, 15)),
((-1, 1, 15), (0, 1, 30), (1, 1, 15)),
((-1, 1, 15), (1, 1, 15), (0, 1, 30)),
((1, 1, 15), (0, 1, 30), (-1, 1, 15)),
((1, 1, 15), (-1, 1, 15), (0, 1, 30)),)
...
def powder_10(chunk, id_and_bit, curr_bit, x: int, y: int):
    ...
    if ((id_and_bit > 2560 and (chunk.prev[(y-1)*12+(x-1)] if (0 <= (x-1) < 12 and 0 <= (y-1) < 12) else chunks.get(((chunk.xo*12+(x-1)) // 12, (chunk.yo*12+(y-1)) // 12), dummy_chunk).prev[((y-1) % 12) * 12 + (x-1) % 12]) not in powder.id_space and (chunk.prev[(y-1)*12+(x+1)] if (0 <= (x+1) < 12 and 0 <= (y-1) < 12) else chunks.get(((chunk.xo*12+(x+1)) // 12, (chunk.yo*12+(y-1)) // 12), dummy_chunk).prev[((y-1) % 12) * 12 + (x+1) % 12]) not in powder.id_space and (chunk.prev[( y-1)*12+(x)] if (0 <= (x) < 12 and 0 <= ( y-1) < 12) else chunks.get(((chunk.xo*12+(x)) // 12, (chunk.yo*12+( y-1)) // 12), dummy_chunk).prev[(( y-1) % 12) * 12 + (x) % 12]) not in powder.id_space) or
        (id_and_bit == 2560 and (chunk.prev[(y-1)*12+(x)] if (0 <= (x) < 12 and 0 <= (y-1) < 12) else chunks.get(((chunk.xo*12+(x)) // 12, (chunk.yo*12+(y-1)) // 12), dummy_chunk).prev[((y-1) % 12) * 12 + (x) % 12])  in powder.detatch_if and (chunk.prev[(y-1)*12+(x+1)] if (0 <= (x+1) < 12 and 0 <= (y-1) < 12) else chunks.get(((chunk.xo*12+(x+1)) // 12, (chunk.yo*12+(y-1)) // 12), dummy_chunk).prev[((y-1) % 12) * 12 + (x+1) % 12])  in powder.detatch_if and (chunk.prev[( y-1)*12+(x)] if (0 <= (x) < 12 and 0 <= ( y-1) < 12) else chunks.get(((chunk.xo*12+(x)) // 12, (chunk.yo*12+( y-1)) // 12), dummy_chunk).prev[(( y-1) % 12) * 12 + (x) % 12])  in powder.detatch_if)):
        
        new_chunk = chunk if 0 <= (x) < 12 and 0 <= (y) < 12 else chunks.get(((chunk.xo*12+(x)) // 12, (chunk.yo*12+(y)) // 12), dummy_chunk)
        ly, lx = (y), (x)
        if new_chunk != chunk:
            ly, lx = (y) % 12, (x) % 12
        new_chunk.data[ly*12 + lx] = (3072)
        new_chunk.visited.add((lx, ly))
        new_chunk.is_uniform = False
        new_chunk.first_assign = False
...
def powder_12(chunk, id_and_bit, curr_bit, x: int, y: int):
...
def powder_14(chunk, id_and_bit, curr_bit, x: int, y: int):
